...
struct corstone315_nsacfg_block_t {
...
{
    struct corstone315_sacfg_block_t* p_sacfg =
                         (struct corstone315_sacfg_block_t*)dev->cfg->sacfg_base;
    struct corstone315_nsacfg_block_t* p_nsacfg =
                       (struct corstone315_nsacfg_block_t*)dev->cfg->nsacfg_base;
