...
/* Corstone-315 PPC driver structures */
#ifdef PPC_CORSTONE315_MAIN0_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_MAIN0_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                       .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                       .ppc_name = PPC_CORSTONE315_MAIN0};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_MAIN0_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_MAIN0_DEV_S = {&PPC_CORSTONE315_MAIN0_CFG_S,
                                                            &PPC_CORSTONE315_MAIN0_DATA_S};
#endif

#ifdef PPC_CORSTONE315_MAIN_EXP0_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_MAIN_EXP0_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                           .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                           .ppc_name = PPC_CORSTONE315_MAIN_EXP0};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_MAIN_EXP0_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_MAIN_EXP0_DEV_S = {&PPC_CORSTONE315_MAIN_EXP0_CFG_S,
                                                                &PPC_CORSTONE315_MAIN_EXP0_DATA_S};
#endif

#ifdef PPC_CORSTONE315_MAIN_EXP1_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_MAIN_EXP1_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                           .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                           .ppc_name = PPC_CORSTONE315_MAIN_EXP1};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_MAIN_EXP1_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_MAIN_EXP1_DEV_S = {&PPC_CORSTONE315_MAIN_EXP1_CFG_S,
                                                                &PPC_CORSTONE315_MAIN_EXP1_DATA_S};
#endif

#ifdef PPC_CORSTONE315_MAIN_EXP2_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_MAIN_EXP2_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                           .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                           .ppc_name = PPC_CORSTONE315_MAIN_EXP2};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_MAIN_EXP2_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_MAIN_EXP2_DEV_S = {&PPC_CORSTONE315_MAIN_EXP2_CFG_S,
                                                                &PPC_CORSTONE315_MAIN_EXP2_DATA_S};
#endif

#ifdef PPC_CORSTONE315_MAIN_EXP3_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_MAIN_EXP3_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                           .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                           .ppc_name = PPC_CORSTONE315_MAIN_EXP3};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_MAIN_EXP3_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_MAIN_EXP3_DEV_S = {&PPC_CORSTONE315_MAIN_EXP3_CFG_S,
                                                                &PPC_CORSTONE315_MAIN_EXP3_DATA_S};
#endif

#ifdef PPC_CORSTONE315_PERIPH0_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_PERIPH0_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                         .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                         .ppc_name = PPC_CORSTONE315_PERIPH0};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_PERIPH0_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_PERIPH0_DEV_S = {&PPC_CORSTONE315_PERIPH0_CFG_S,
                                                              &PPC_CORSTONE315_PERIPH0_DATA_S};
#endif

#ifdef PPC_CORSTONE315_PERIPH1_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_PERIPH1_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                         .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                         .ppc_name = PPC_CORSTONE315_PERIPH1};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_PERIPH1_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_PERIPH1_DEV_S = {&PPC_CORSTONE315_PERIPH1_CFG_S,
                                                              &PPC_CORSTONE315_PERIPH1_DATA_S};
#endif

#ifdef PPC_CORSTONE315_PERIPH_EXP0_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_PERIPH_EXP0_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                             .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                             .ppc_name = PPC_CORSTONE315_PERIPH_EXP0};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_PERIPH_EXP0_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_PERIPH_EXP0_DEV_S = {&PPC_CORSTONE315_PERIPH_EXP0_CFG_S,
                                                                  &PPC_CORSTONE315_PERIPH_EXP0_DATA_S};
#endif

#ifdef PPC_CORSTONE315_PERIPH_EXP1_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_PERIPH_EXP1_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                             .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                             .ppc_name = PPC_CORSTONE315_PERIPH_EXP1};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_PERIPH_EXP1_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_PERIPH_EXP1_DEV_S = {&PPC_CORSTONE315_PERIPH_EXP1_CFG_S,
                                                                  &PPC_CORSTONE315_PERIPH_EXP1_DATA_S};
#endif

#ifdef PPC_CORSTONE315_PERIPH_EXP2_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_PERIPH_EXP2_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                             .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                             .ppc_name = PPC_CORSTONE315_PERIPH_EXP2};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_PERIPH_EXP2_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_PERIPH_EXP2_DEV_S = {&PPC_CORSTONE315_PERIPH_EXP2_CFG_S,
                                                                  &PPC_CORSTONE315_PERIPH_EXP2_DATA_S};
#endif

#ifdef PPC_CORSTONE315_PERIPH_EXP3_S
static struct ppc_corstone315_dev_cfg_t PPC_CORSTONE315_PERIPH_EXP3_CFG_S = {.sacfg_base = CORSTONE315_SACFG_BASE_S,
                                                                             .nsacfg_base = CORSTONE315_NSACFG_BASE_NS,
                                                                             .ppc_name = PPC_CORSTONE315_PERIPH_EXP3};
static struct ppc_corstone315_dev_data_t PPC_CORSTONE315_PERIPH_EXP3_DATA_S = {
    .sacfg_ns_ppc = 0, .sacfg_sp_ppc = 0, .nsacfg_nsp_ppc = 0, .int_bit_mask = 0, .is_initialized = false};
struct ppc_corstone315_dev_t PPC_CORSTONE315_PERIPH_EXP3_DEV_S = {&PPC_CORSTONE315_PERIPH_EXP3_CFG_S,
                                                                  &PPC_CORSTONE315_PERIPH_EXP3_DATA_S};
#endif
